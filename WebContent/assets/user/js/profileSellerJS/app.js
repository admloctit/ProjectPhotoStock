...
var App = function () {
	...
	function handlePurchase() {
		jQuery('body').append('<a href="https://goo.gl/oEEjtr" class="purchase-unify" target="_blank"><i class="fa fa-usd" style="margin-right: 5px; font-weight: bold;"></i>Buy Unify</a>');
		jQuery('.purchase-unify').css({
      'position': 'fixed',
      'top': '93px',
      'right': '0',
      'background': '#72c02c',
