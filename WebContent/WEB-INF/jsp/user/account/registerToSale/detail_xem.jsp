				...
				<div
					...
					<div class="form-wizard form-header-classic form-body-classic">
						...
						<s:form method="post" commandName="seller"
							action="${pageContext.request.contextPath }/account/registerToSale/detail.html">
						...
						<%-- <s:form action="${initParam['posturl'] }" method="post" commandName="seller"> --%>
							...
							<div class="form-wizard-steps form-wizard-tolal-steps-2">
								<div class="form-wizard-progress">
									<div class="form-wizard-progress-line" data-now-value="12.25"
										data-number-of-steps="2" style="width: 12.25%;"></div>
								</div>
								<!-- Step 1 -->
							...
							<fieldset>
                                ...
                                <div class="form-wizard-buttons">
                                    <button type="button" class="btn btn-previous">Active</button>
                                </div>
                            </fieldset>
							<!-- Form Step 1 -->
							...
							<fieldset>
								...
								<!-- Progress Bar -->
								<h4>
									Payment Information: <span>Step 2 - 2</span>
								</h4>
								...
								<br />
								<div class="form-wizard-buttons">
									<a href="#" class="btn btn-previous">Home</a>
