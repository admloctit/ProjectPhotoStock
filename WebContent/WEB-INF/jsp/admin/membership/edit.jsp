...
<section class="content" style="min-height: 815px;">
				...
				<s:form method="post" commandName="membership"
					...
					action="${pageContext.request.contextPath }/admin/membership/edit.html">
					<div class="box-body">
						<div class="form-group row">
							<label class="col-sm-2 control-label">Id</label>
							<div class="col-sm-10">
								<s:input path="id" class="form-control" readonly="true" id="id" />
							</div>
						</div>
						<div class="form-group row">
					...
					<div class="box-footer">
						...
						<button type="submit" class="btn btn-info pull-right"
							formaction="${pageContext.request.contextPath }/admin/membership/edit.html">Save</button>
					</div>
					<!-- /.box-footer -->
				</s:form>
